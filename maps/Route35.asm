...
IF DEF(_09_29) || DEF(_09_30) || DEF(_10_06)
	object_event  2, 10, SPRITE_FISHER, SPRITEMOVEDATA_SPINCOUNTERCLOCKWISE, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 3, TrainerFirebreatherWalt, -1
ELIF DEF(_REV0)
...
IF DEF(_09_29) || DEF(_09_30) || DEF(_10_06)
	object_event  5, 10, SPRITE_SUPER_NERD, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerJugglerIrwin, -1
ELIF DEF(_REV0)
